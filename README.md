Sí, así queda mucho mejor para el repositorio. Podemos darle un estilo más **interactivo y visual**, especialmente diferenciando:
...
Y además podemos agregar una tabla de navegación al inicio para que el `curso.md` se sienta como una pequeña documentación del curso.

Te recomiendo usar este estilo para `filter/curso.md`:
...
> 💡 **Recuerda:** `filter()` conserva los elementos cuya condición devuelve `True`.
